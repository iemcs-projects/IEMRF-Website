...
export const internshipProjects: InternshipProject[] = [
  ...
  },
  {
    ...
    title: "CREABOOST – Blockchain-Based Incentivized Federated Learning dApp",
    department: "IEMRF Projects",
    domain: "Blockchain / Web3",
    description: "To create a fair, privacy-first digital advertising ecosystem that empowers content creators by securely aggregating engagement data and rewarding verified contributions transparently. Guide: Sudip Kumar Palit",
    image: "/cREABOOST.png",
    season: "Winter",
    year: 2025,
    status: "ongoing",
  ...
  },
  {
    ...
    title: "ARBITRADER – Smart Arbitrage Trading for Stocks & Cryptos",
    department: "IEMRF Projects",
    domain: "FinTech / Trading",
    description: "To empower traders with real-time, automated arbitrage intelligence that helps them capitalize on price differences across markets with speed, clarity, and reduced risk. Guide: Sudip Kumar Palit",
  ...
  },
  {
    ...
    title: "Trade Sim – AI-Powered Trading Simulation Platform",
    department: "IEMRF Projects",
    domain: "FinTech / Simulation",
    description: "To make financial market learning safe, transparent, and beginner-friendly by combining risk-free trading, real-time data, and explainable AI-driven insights. Guide: Saugata Ghosh",
    image: "/Tradesim.png",
    season: "Winter",
    year: 2025,
    status: "ongoing",
