      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        <AnimatedSection className="mt-8">
          <div className="flex items-center justify-center gap-2">
            <button onClick={() => setTab("all")} className={`rounded-full px-4 py-1.5 text-sm font-medium border ${tab==='all' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300'}`}>All</button>
            <button onClick={() => setTab("upcoming")} className={`rounded-full px-4 py-1.5 text-sm font-medium border ${tab==='upcoming' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300'}`}>Upcoming</button>
            <button onClick={() => setTab("past")} className={`rounded-full px-4 py-1.5 text-sm font-medium border ${tab==='past' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300'}`}>Past</button>
          </div>
        </AnimatedSection>
