...
export const leadershipTeam: LeadershipProfile[] = [
  {
...

   {
    ...
    role: "COO",
    // designation: "Professor & Head of Research Innovation",
    bio: "Diptiman Dasgupta (DD), is an Industry leader with 29 years of experience in IT Industry, especially in Enterprise Architecture, SOA & Enterprise Integration, Blockchain, Cloud and ISV Program leadership. Currently he serves as Group COO for IEM UEM group and IEM Research Foundation (IEMRF). Previously he was an IBM Executive IT Architect & Associate Partner, Open Group Distinguished Architect and IBM Senior Inventor leading complex enterprise initiatives, Architecture Professions and new technology incubation in IBM. In IBM he led Green IT & Sustainability, Industry Cloud Program and Blockchain projects, and served as Architect Profession Leader in IBM India/SA.He was a Member of IBM Academy of Technology (top 1% globally), four-time IBM Outstanding Technical Achievements Award receiver in IBM, and IBM Senior Inventor with 10+ patents and 17+ publications. In his current role Diptiman is leading start up incubation in IEMRF, strategic collaboration & partnership with IIT KGP by leading a ‘DeepTech Center of Excellence (CoE) and driving MBA program from leadership & strategic direction and transformation standpoint towards making it more Industry aligned.",
    // expertise: [
    //   "Artificial Intelligence",
    //   "Machine Learning",
    //   "Computer Vision",
